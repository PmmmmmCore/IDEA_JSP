...
<%
    ...
    try {
        ...
        String insert_sql = "UPDATE jianli SET name='" + name + "',sex='" + sex + "',chusheng='" + chusheng + "',mingzu=' " + mingzu + "',zhengzhi='"  + zhengzhi + "',hunyin='"+ hunyin + "',jiguan='" + jiguan + "',suozaidi='" + suozaidi + "',dianhua='" + dianhua + "',qizhi1=' " + qizhi1 + "',xuexiao1='" + xuexiao1 + "',zhuanye1='" + zhuanye1 + "',xueli1='" + xueli1 + "',xuewei1='" + xuewei1 + "',qizhi2='" + qizhi2 + "',xuexiao2=' " + xuexiao2 + "',zhuanye2='" + zhuanye2 + "',xueli2='" + xueli2 + "',xuewei2='" + xuewei2 + "',qizhi3='" + qizhi3 + "',xuexiao3='" + xuexiao3 + "',zhuanye3=' " + zhuanye3 + "',xueli3='" + xueli3 + "',xuewei3='" + xuewei3 + "',qizhi4='" + qizhi4 + "',danwei1='" + danwei1 + "',zhiwei1='" + zhiwei1 + "',zhize1=' " + zhize1 + "',qizhi5='" + qizhi5 + "',danwei2='" + danwei2 + "',zhiwei2='" + zhiwei2 + "',zhize2='" + zhize2 + "',qizhi6='" + qizhi6 + "',danwei3=' " + danwei3 + "',zhiwei3='" + zhiwei3 + "',zhize3='" + zhize3 + "',qizhi7='" + qizhi7 + "',danwei4='" + danwei4 + "',zhiwei4='" + zhiwei4 + "',zhize4='" + zhize4 + "',ruanjian='" + ruanjian + "',putonghua='" + putonghua + "',yingwen='" + yingwen + "',qita='" + qita + "',zige='" + zige + "',aihao='" + aihao + "',rongyu='" + rongyu + "',ziwopingjia='" + ziwopingjia + "' WHERE email='"+str+"'";
        // String insert_sql = "INSERT INTO jianli (name) VALUES ('"+name+"')";
        try {
            stmt.execute(insert_sql);
            response.sendRedirect("update_done.html");
        }catch (Exception e) {
            e.printStackTrace();
        }
        stmt.close();
