...
<form action="admin_pass.jsp" method="post">
    <table border="2" width="800"  style="border-color: rgb(97,163,52)" align="center" >
        ...
        <tr><th>语言能力</th><th>普通话</th><td><input type="text" name="putonghua" value="<%=rs.getString("putonghua")%>"></td><th>英语</th><td><input type="text" name="yingwen" value="<%=rs.getString("yingwen")%>"></td></tr>
